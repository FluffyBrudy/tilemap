...
class PropertyEditor:
    ...
    def _commit_save(self) -> bool:
        """Save working properties via dispatch. Stays open either way.

        Returns True when a handler accepted the save. Immediate-save
        model: there is no staged state, so closing can never lose edits.
        """
