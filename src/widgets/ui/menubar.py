...
class MenuBar:
    def __init__(self, editor, width: int, height: int = 30):
        ...
        self.menus = [
            Menu("File", [
                ...
                MenuAction("Save As...", self.editor.open_save_as_dialog, "Ctrl+Shift+S"),
            ...
            Menu("Tools", [
                ...
                MenuAction("Launch Automap Viewer", self.editor.launch_external_automap),
            ]),
            Menu("View", [
    ...
    def _layout_menus(self):
        ...
        for menu in self.menus:
            ...
            menu.dropdown_rect = Rect(x, self.rect.height, max_w, len(menu.actions) * item_h + 10)
            x += w
    ...
    def handle_event(self, event: pygame.event.Event) -> bool:
            ...
            if event.button == 1:
                ...
                for menu in self.menus:
                    if menu.rect.collidepoint(mouse_pos):
                        ...
                        for m in self.menus: m.is_open = False
        ...
        if event.type in (pygame.MOUSEBUTTONDOWN, pygame.MOUSEBUTTONUP, pygame.MOUSEMOTION, pygame.MOUSEWHEEL):
            return any(m.is_open and m.dropdown_rect.collidepoint(mouse_pos) for m in self.menus) or self.rect.collidepoint(mouse_pos)
    ...
    def draw(self, screen: pygame.Surface):
        ...
        pygame.draw.line(screen, self.border_color, (0, self.rect.height-1), (self.rect.width, self.rect.height-1))
        ...
        for menu in self.menus:
            ...
            if menu.is_open:
                ...
                pygame.draw.rect(screen, self.accent_color, (menu.rect.x, menu.rect.height-2, menu.rect.width, 2))
            elif is_hover:
            ...
            if menu.is_open:
                ...
                pygame.draw.rect(screen, (20, 20, 25, 100), shadow_rect) # Simple shadow
                ...
                for i, action in enumerate(menu.actions):
                    item_rect = Rect(menu.dropdown_rect.x + 2, menu.dropdown_rect.y + 5 + i*26, menu.dropdown_rect.width - 4, 26)
                    ...
                    if action.shortcut:
                        sh_surf = self.font_shortcut.render(action.shortcut, True, shortcut_color)
                        screen.blit(sh_surf, (item_rect.right - sh_surf.get_width() - 10, item_rect.y + 7))
